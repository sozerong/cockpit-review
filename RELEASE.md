...
Built artifacts: `C:\Users\dudfo\AppData\Local\Temp\cockpit_dist\cockpit_review-0.1.0*`
...
twine check C:\Users\dudfo\AppData\Local\Temp\cockpit_dist\cockpit_review-0.1.0*
...
```powershell
# 4. TestPyPI dry run
twine upload -r testpypi C:\Users\dudfo\AppData\Local\Temp\cockpit_dist\cockpit_review-0.1.0*

# 5. Verify from TestPyPI in a clean venv
py -3.11 -m venv .venv-verify
.\.venv-verify\Scripts\Activate.ps1
pip install --index-url https://test.pypi.org/simple/ --extra-index-url https://pypi.org/simple/ cockpit-review==0.1.0
cockpit --version
deactivate

# 6. Real PyPI
twine upload C:\Users\dudfo\AppData\Local\Temp\cockpit_dist\cockpit_review-0.1.0*
